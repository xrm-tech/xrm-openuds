    ...
    def __send_data(self, plan_data_list_param):
        ...
        for plan_data_dict in plan_data_list_param:
            ...
            try:#TODO: реворк с kwargs                
                ...
                dst_broker_connection= Client(host= dst_broker_ip,
                ...
                create_static_provider= dst_broker_connection.create_static_provider(
